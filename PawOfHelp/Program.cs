...
using PawOfHelp.BackgroundServices;
...
using PawOfHelp.Validators.Organization;
using PawOfHelp.Validators.Post;
using PawOfHelp.Validators.ReferenceBook;
...
builder.Services.AddScoped<IValidator<ReferenceBookRequestDto>, ReferenceBookRequestValidator>();
builder.Services.AddScoped<IValidator<UpdateProfileDto>, UpdateProfileValidator>();
builder.Services.AddScoped<IValidator<UpdateOrganizationDto>, UpdateOrganizationValidator>();
